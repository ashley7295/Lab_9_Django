...
class TestHomePage(TestCase):
    ...
    def test_home_page_shows_empty_list_messge_for_empty_database(self):
        home_page_url = reverse('plase_list')
...
class TestVisitedPage(TestCase):
    ...
    def test_visited_page_shows_empty_list_message_for_empty_database(self):
        ...
        self.assertTemplateUsed(response, 'travel/wishlist/visited.html')
...
class TestAddNewPlace(TestCase):
    ...
    def test_add_new_unvisited_place(self):
        ...
        self.assertTemplateUsed(response, 'travel_wishlist/wishlist.html')
        response_places = response.cotext['places']
